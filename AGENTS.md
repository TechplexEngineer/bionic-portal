...
5. **Document Results**: Add review section to `agents/plans/YYYY-MM-DD_HH-MM-SS_plan.md`
...
- **Minimal Custom Styling**: Minimize use of custom styling and CSS. Rely on Bootstrap elements and utility classes wherever possible.
